...
public:
    ...
    // OUR METHODS HERE
    virtual bool checkHit( unsigned long address );
    virtual void addressHit( unsigned long address );
    virtual unsigned long getVictim( unsigned long address );
    virtual void addressMiss( unsigned long address );
